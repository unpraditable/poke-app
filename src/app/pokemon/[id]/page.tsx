...
async function getPokemonData(id: string): Promise<PokemonDetail> {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-lg">
            <h2 className="text-xl font-bold text-gray-800 p-6">About</h2>
            <div className="grid grid-cols-[70px_1fr] p-6">
              <h3 className="text-gray-800 text-sm font-bold mb-2">Height</h3>
              <p className="text-gray-800 mb-2">{heightMeters}m</p>

              <h3 className="text-gray-800 text-sm font-bold mb-2">Weight</h3>
              <p className="text-gray-800 mb-2">{weightKg} kg</p>
